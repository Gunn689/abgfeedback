...
// Railway: bind to process.env.PORT, listen on 0.0.0.0
...
// supports both application/x-www-form-urlencoded AND raw base64 body
function parseBody(buf, contentType) {
    ...
    // fallback: assume whole body is base64
...
function decodeImage(raw) {
    ...
    // if it was URL-encoded by the Lua client, URLSearchParams already decoded it — this is a safety pass
...
const server = http.createServer((req, res) => {
    ...
    // accept POST on both / and /upload for compatibility with any Lua client
